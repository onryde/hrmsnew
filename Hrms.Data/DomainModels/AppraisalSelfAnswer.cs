...
{
    public partial class AppraisalSelfAnswer
    {
        [Column("id")]
        ...
        [ForeignKey("AddedBy")]
        [InverseProperty("AppraisalSelfAnswerAddedByNavigation")]
        public virtual Employee AddedByNavigation { get; set; }
        [ForeignKey("AppraisalEmployeeId")]
        [InverseProperty("AppraisalSelfAnswer")]
        ...
        [InverseProperty("AppraisalSelfAnswerUpdatedByNavigation")]
